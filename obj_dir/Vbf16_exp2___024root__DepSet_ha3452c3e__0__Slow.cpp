...
VL_ATTR_COLD void Vbf16_exp2___024root___stl_sequent__TOP__0(Vbf16_exp2___024root* vlSelf) {
    ...
    bf16_exp2__DOT__u_unified_shift__DOT__unified_shifted 
        = (0x7fffffffffffULL & (VL_LTES_III(32, 0U, 
                                            VL_EXTENDS_II(32,9, (IData)(bf16_exp2__DOT__u_decompose__DOT__exponent_comb)))
                                 ? VL_SHIFTL_QQI(47,47,9, 
                                                 ((QData)((IData)(
                                                                  (0x7fffffffU 
                                                                   & ((IData)(vlSelf->s_axis_tuser)
                                                                       ? 
                                                                      ...
                                                                      ((IData)(0x5c551dU) 
                                                                       * (IData)(bf16_exp2__DOT__s3_mant_src)))))) 
                                                  << 9U), (IData)(bf16_exp2__DOT__u_decompose__DOT__exponent_comb))
