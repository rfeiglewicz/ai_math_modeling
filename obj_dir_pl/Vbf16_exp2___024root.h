...
class alignas(VL_CACHE_LINE_BYTES) Vbf16_exp2___024root final : public VerilatedModule {
  public:
    ...
    SData/*11:0*/ bf16_exp2__DOT__gen_axi_pipelined__DOT__vld_sr;
    ...
    VlUnpacked<SData/*8:0*/, 3> bf16_exp2__DOT__exp_delay;
    VlUnpacked<SData/*8:0*/, 5> bf16_exp2__DOT__int_delay;
    VlUnpacked<CData/*1:0*/, 10> bf16_exp2__DOT__eo_delay;
