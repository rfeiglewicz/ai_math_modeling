...
VL_ATTR_COLD void Vbf16_expe_hybrid___024root___ctor_var_reset(Vbf16_expe_hybrid___024root* vlSelf) {
    ...
    vlSelf->bf16_expe_hybrid__DOT__core_data = VL_RAND_RESET_I(16);
    vlSelf->bf16_expe_hybrid__DOT__gen_axi_pipelined__DOT__valid_sr = VL_RAND_RESET_I(16);
    ...
    vlSelf->bf16_expe_hybrid__DOT__u_pipe_pad__DOT__gen_delay__DOT__gen_stage__BRA__5__KET____DOT__nxt = VL_RAND_RESET_I(16);
    vlSelf->bf16_expe_hybrid__DOT__u_pipe_pad__DOT__gen_delay__DOT__gen_stage__BRA__6__KET____DOT__nxt = VL_RAND_RESET_I(16);
    vlSelf->bf16_expe_hybrid__DOT__u_pipe_pad__DOT__gen_delay__DOT__gen_stage__BRA__7__KET____DOT__nxt = VL_RAND_RESET_I(16);
    vlSelf->bf16_expe_hybrid__DOT__u_pipe_pad__DOT__gen_delay__DOT__gen_stage__BRA__8__KET____DOT__nxt = VL_RAND_RESET_I(16);
    vlSelf->bf16_expe_hybrid__DOT__u_pipe_pad__DOT__gen_delay__DOT__gen_stage__BRA__9__KET____DOT__nxt = VL_RAND_RESET_I(16);
    vlSelf->bf16_expe_hybrid__DOT__u_pipe_pad__DOT__gen_delay__DOT__gen_stage__BRA__10__KET____DOT__nxt = VL_RAND_RESET_I(16);
    vlSelf->bf16_expe_hybrid__DOT__u_pipe_pad__DOT__gen_delay__DOT__gen_stage__BRA__11__KET____DOT__nxt = VL_RAND_RESET_I(16);
