    ...
    if (vlSelf->rst_n) {
        if (vlSelf->s_axis_tready) {
            vlSelf->bf16_expe_cut__DOT__gen_axi_pipelined__DOT__valid_sr 
                = ((0xeU & ((IData)(vlSelf->bf16_expe_cut__DOT__gen_axi_pipelined__DOT__valid_sr) 
                            << 1U)) | (IData)(vlSelf->s_axis_tvalid));
            vlSelf->bf16_expe_cut__DOT__s3_frac = vlSelf->bf16_expe_cut__DOT__s2_frac;
            vlSelf->m_axis_tdata = ((3U == (IData)(vlSelf->bf16_expe_cut__DOT__s3_eo_code))
                                     ? 0xffc0U : ((1U 
                                                   == (IData)(vlSelf->bf16_expe_cut__DOT__s3_eo_code))
                                                   ? 0x3f80U
                                                   : 
                                                  ((2U 
                                                    == (IData)(vlSelf->bf16_expe_cut__DOT__s3_eo_code))
