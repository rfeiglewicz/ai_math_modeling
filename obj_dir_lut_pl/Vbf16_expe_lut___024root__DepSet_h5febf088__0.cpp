    ...
    if (vlSelf->rst_n) {
        if (vlSelf->s_axis_tready) {
            vlSelf->bf16_expe_lut__DOT__gen_axi_pipelined__DOT__vld_sr 
                = ((0xeU & ((IData)(vlSelf->bf16_expe_lut__DOT__gen_axi_pipelined__DOT__vld_sr) 
                                      ...
                                      : ((0x200000U 
                                          ...
                                          ? (VL_GTS_III(9, 0x1f7U, 
                                             ...
                                             (VL_LTS_III(9, 7U, 
                                               ...
                                               : 0U))
                                          : 1U))));
            vlSelf->m_axis_tdata = ((3U == vlSelf->bf16_expe_lut__DOT__eo_delay
                                     [1U]) ? 0xffc0U
                                     : ((1U == vlSelf->bf16_expe_lut__DOT__eo_delay
                                         [1U]) ? 0x3f80U
                                         : ((2U == 
                                             vlSelf->bf16_expe_lut__DOT__eo_delay
                                             [1U]) ? 0U
