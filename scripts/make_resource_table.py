...
def main():
    ...
    A("inny musi zostac dopelniony do tej samej liczby.")
    A("")
    A("Pierwszy stopien dopelnienia jest wymuszony jako przerzutnik")
    A("(`bf16_pipe_pad`, `HEAD_FF`), reszta laduje w SRL16E. Bez tego Vivado")
    A("wciaga rejestr wyjsciowy rdzenia do lancucha SRL i kombinacyjne wyjscie")
    A("rdzenia trafia wprost na wejscie D bloku SRL, ktory ma gorszy czas")
    A("ustalania. Zmierzone na `expe full-lut`: dopelnienie z 4 na 8 stopni")
    A("zbijalo Fmax z 283.4 na 254.1 MHz przy niezmienionym opoznieniu logiki.")
    A("")
